<x-layout :title="'Login'" class="flex flex-col items-center mx-2">
    <div class="w-full h-screen flex items-center">
        <x-card
            class="bg-gradient-to-b from-slate-300 to-slate-100 w-[450px] h-[450px] flex flex-col justify-center items-center relative">
                ...
                <div class="flex flex-col gap-8 justify-center items-center">
                    <div class="w-full h-full flex flex-col justify-center items-start">
                        ...
                        <input type="text" name="login"
                            ...
                            value="{{ old('login') }}" placeholder="Username or Email" />
                    </div>
